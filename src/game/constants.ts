...
export const L = 2.540, W = 1.270, BR = 0.0285750          // metres
...
export const POCK_C = 0.060, POCK_M = 0.067
export const POCKETS = [
  { x: 0, y: 0, r: POCK_C }, { x: L, y: 0, r: POCK_C },
  { x: 0, y: W, r: POCK_C }, { x: L, y: W, r: POCK_C },
  { x: L / 2, y: 0, r: POCK_M }, { x: L / 2, y: W, r: POCK_M },
]

// physics constants (SI)
export const G = 9.8, MU_SLIDE = 0.20, MU_ROLL = 0.012, MU_BALL = 0.06
export const E_BALL = 0.95, E_CUSH = 0.86
export const RAIL_SPIN = 0.40, RAIL_SPIN_DECAY = 0.55, TAU_SPIN = 4.0
...
export const DT = 1 / 600, V_STOP = 0.008, SLIP_EPS = 0.02, W_STOP = 0.4, TIME_SCALE = 1.3

export const BASECOLORS: Record<number, string> =
  { 1: '#e6b800', 2: '#1f4fd1', 3: '#d11f1f', 4: '#6a1fb0', 5: '#e07b1f', 6: '#1f8f3a', 7: '#7a1f2b', 8: '#111' }
